    ...
    return (
        <div id='projects' className='w-[100%] bg-theme_bg'>
            <div className='container mt-[80px]'>
                ...
                <h1 data-aos="fade-down" data-aos-delay="200" className="text-theme_fg_copy sm:text-3xl text-2xl px-5 sm:px-0 sm:text-start pt-[60px]  aos-init aos-animate">{title}</h1>

                <h1
                    data-aos="fade-down"
                    data-aos-delay={200}
                    className='text-theme_bg_copy/60 sm:text-3xl text-2xl px-5 sm:px-0 sm:text-start font-paprika mb-[20px] sm:mb-[40px] pt-2'>{subtitle}</h1>
